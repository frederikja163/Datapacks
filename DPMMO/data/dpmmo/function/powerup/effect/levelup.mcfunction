...
$execute unless score @s dpmmo_tmp = @s $(skill)_Amplifier run tellraw @s ["    ", {storage:"dpmmo:skill", nbt:"$(skill).Effect", interpret: true, color: gold}, " ", {score:{name:"@s",objective:"dpmmo_tmp"},color:gold}, {text:" → ", color: white},  {storage:"dpmmo:skill", nbt:"$(skill).Effect", interpret: true, color: gold}, " ", {score:{name:"@s",objective:"$(skill)_Amplifier"},color:gold}]
...
$execute unless score @s dpmmo_tmp = @s $(skill)_time_max run tellraw @s ["    ", {storage:"dpmmo:skill", nbt:"$(skill).Effect", interpret: true, color: gold}, " ", {score:{name:"@s",objective:"dpmmo_tmp"},color:aqua}, {text:"s", color: aqua}, {text:" → ", color: white}, {score:{name:"@s",objective:"$(skill)_time_max"},color:aqua}, {text:"s", color: aqua}]
