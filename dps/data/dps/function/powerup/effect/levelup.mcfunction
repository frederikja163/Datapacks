...
$execute unless score @s dps_tmp = @s $(skill)_Amplifier run tellraw @s ["    ", {storage:"dps:skill", nbt:"$(skill).Effect", interpret: true, color: gold}, " ", {score:{name:"@s",objective:"dps_tmp"},color:gold}, {text:" → ", color: white},  {storage:"dps:skill", nbt:"$(skill).Effect", interpret: true, color: gold}, " ", {score:{name:"@s",objective:"$(skill)_Amplifier"},color:gold}]
...
$execute unless score @s dps_tmp = @s $(skill)_time_max run tellraw @s ["    ", {storage:"dps:skill", nbt:"$(skill).Effect", interpret: true, color: gold}, " ", {score:{name:"@s",objective:"dps_tmp"},color:aqua}, {text:"s", color: aqua}, {text:" → ", color: white}, {score:{name:"@s",objective:"$(skill)_time_max"},color:aqua}, {text:"s", color: aqua}]
