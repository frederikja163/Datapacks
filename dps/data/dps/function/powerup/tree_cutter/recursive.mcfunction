...
$execute positioned ~1 ~1 ~1 if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
$execute positioned ~1 ~1 ~ if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
$execute positioned ~1 ~1 ~-1 if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
$execute positioned ~1 ~ ~1 if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
$execute positioned ~1 ~ ~ if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
$execute positioned ~1 ~ ~-1 if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
$execute positioned ~1 ~-1 ~1 if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
$execute positioned ~1 ~-1 ~ if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
$execute positioned ~1 ~-1 ~-1 if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
...
$execute positioned ~ ~1 ~-1 if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
$execute positioned ~ ~ ~1 if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
# $execute positioned ~ ~ ~ if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
$execute positioned ~ ~ ~-1 if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
$execute positioned ~ ~-1 ~1 if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
$execute positioned ~ ~-1 ~ if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
$execute positioned ~ ~-1 ~-1 if block ~ ~ ~ #dps:logs run function dps:powerup/tree_cutter/recursive {skill: "$(skill)"}
